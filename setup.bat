...
pyinstaller --onefile -y -i "rsscrawler/web/img/favicon.ico" --version-file "file_version_info.txt" --hidden-import "_rapidfuzz_cpp" --add-data "%localappdata%\Programs\Python\Python37-32\Lib\site-packages\cloudscraper\;cloudscraper" --add-data "rsscrawler/web;web" "RSScrawler.py" -n "rsscrawler-%version%-standalone-win32"
