      ...
      <div id="accordionLists" class="accordion">
        <div v-if="hostnames.bl !== 'Nicht gesetzt!'" class="accordion-item">
          ...
          <div id="collapseZeroOne" aria-labelledby="headingZeroOne" class="accordion-collapse collapse"
            ...
            <div class="accordion-body">
              <h5>Filme</h5>
              <textarea v-model="lists.mb.filme" class="liste form-control" data-toggle="tooltip"
                        title="Pro Zeile ein Filmtitel (wahlweise mit Erscheinungsjahr in Klammern)."></textarea>
              <h5 v-if="settings.mb.regex">Filme/Serien (RegEx)</h5>
              <textarea v-if="settings.mb.regex" v-model="lists.mb.regex" class="liste form-control"
                        data-toggle="tooltip"
                        title="Pro Zeile ein Film-/Serientitel im RegEx-Format - Die Filterliste wird hierbei ignoriert."></textarea>
              <div v-if="settings.mbsj.enabled && hostnames.s === 'Nicht gesetzt!'">
                <h5>Staffeln</h5>
                <textarea v-model="lists.mbsj.staffeln" class="liste form-control"
                          data-toggle="tooltip"
        ...
        <div v-if="hostnames.s !== 'Nicht gesetzt!'" class="accordion-item">
          ...
          <div id="collapseZeroTwo" aria-labelledby="headingZeroTwo" class="accordion-collapse collapse"
            ...
            <div class="accordion-body">
              <h5>Serien</h5>
              <textarea v-model="lists.sj.serien" class="liste form-control" data-toggle="tooltip"
                        title="Pro Zeile ein Serientitel für Episoden."></textarea>
              <h5 v-if="settings.sj.regex">Serien (RegEx)</h5>
              <textarea v-if="settings.sj.regex" v-model="lists.sj.regex" class="liste form-control"
                        data-toggle="tooltip"
                        title="Pro Zeile ein Serientitel im RegEx-Format für Episoden - Die Filterliste wird hierbei ignoriert."></textarea>
              <h5 v-if="lists.sj.staffeln_regex">Staffeln (RegEx)</h5>
              <textarea v-if="lists.sj.staffeln_regex" v-model="lists.sj.staffeln_regex"
              ...
              <div v-if="settings.mbsj.enabled && hostnames.bl === 'Nicht gesetzt!'">
                <h5>Staffeln</h5>
                <textarea v-model="lists.mbsj.staffeln" class="liste form-control"
                          data-toggle="tooltip"
                          title="Pro Zeile ein Serientitel für ganze Staffeln."></textarea>
        ...
        <div v-if="hostnames.dj !== 'Nicht gesetzt!'" class="accordion-item">
          ...
          <div id="collapseZeroFour" aria-labelledby="headingZeroFour" class="accordion-collapse collapse"
            ...
            <div class="accordion-body">
              <h5>Dokus</h5>
              <textarea v-model="lists.dj.dokus" class="liste form-control" data-toggle="tooltip"
                        title="Pro Zeile ein Dokutitel."></textarea>
              <h5 v-if="settings.dj.regex">Dokus (RegEx)</h5>
              <textarea v-if="settings.dj.regex" v-model="lists.dj.regex" class="liste form-control"
                        data-toggle="tooltip"
