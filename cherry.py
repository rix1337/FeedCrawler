...
<html lang="de">
  ...
  <div class="container">
    ...
    <form id="rsscrawler" enctype="multipart/form-data" target="speichernFrame" method="post" action="speichern">
          ...
          Quellart der Staffeln:<div hinweis="Die Quellart der Staffeln, nach der gesucht wird."><select name="seasonssource"><option value="hdtv|hdtvrip|tvrip"''' + shdtv + '''>HDTV</option><option value="web-dl|webrip|webhd"''' + sweb + '''>WEB</option><option value="hdtv|hdtvrip|tvrip|web-dl|webrip|webhd"''' + shdtvweb + '''>HDTV & WEB</option><option value="bluray|bd|bdrip"''' + sbluray + '''>BluRay</option><option value="web-dl|webrip|webhd|bluray|bd|bdrip"''' + swebbluray + '''>BluRay & Web</option><option value="hdtv|hdtvrip|tvrip|web-dl|webrip|webhd|bluray|bd|bdrip"''' + shdtvwebbluray + '''>HDTV & WEB & BluRay</option></select></div></div>
