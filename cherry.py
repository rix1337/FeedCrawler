...
<html lang="de">
  ...
  <div class="container">
    ...
    <form id="rsscrawler" enctype="multipart/form-data" target="speichernFrame" method="post" action="listenspeichern">
          ...
          <div style='display:''' + ssdiv +'''; 'hinweis="Dieser Bereich ist für die Suche auf ''' + "TW92aWUtQmxvZw==".decode('base64') +  ''' und ''' + "U2VyaWVuSnVua2llcw==".decode('base64') + ''' zuständig."><h3>''' + "TW92aWUtQmxvZw==".decode('base64') +  ''' und ''' + "U2VyaWVuSnVua2llcw==".decode('base64') + '''</h3></div>
          ...
          <div style='display:''' + ytdiv +''';' hinweis="Dieser Bereich ist für die Suche auf YouTube zuständig."><h3>YouTube</h3></div>
