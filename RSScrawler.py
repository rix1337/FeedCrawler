...
class SJ():
    ...
    def periodical_task(self):
        ...
        if self.hoster == "Share-Online":
            ...
            self.hoster = "so"
        # Lege Array als Typ für die added_items fest (Liste bereits hinzugefuegter Releases)
        self.added_items = []
